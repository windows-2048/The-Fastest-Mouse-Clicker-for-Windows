...
int WINAPI WinMain(HINSTANCE instanceH, HINSTANCE prevInstanceH, LPSTR command_line, int show)
{
	...
	windClass.lpszClassName	= "The Fastest Mouse Clicker for Windows Classic";

	//Registering the window class
	RegisterClass(&windClass);

	hWnd=CreateWindow("The Fastest Mouse Clicker for Windows Classic","The Fastest Mouse Clicker for Windows Classic", WS_OVERLAPPEDWINDOW, Sc(100), Sc(100),Sc(438),Sc(480), NULL, NULL, instanceH, NULL);
...
LRESULT CALLBACK winCallBack(HWND hWin, UINT msg, WPARAM wp, LPARAM lp) 
{
	...
	case WM_COMMAND:
		...
		case RESET_BTN:
			...
			break;
		case HELP_BTN:
			MessageBox(hWnd, "The Fastest Mouse Clicker for Windows Classic 2.1.6.0 (Independent Keys For Toggle Clicking; Window Always Top; Random Clicking)."
				...
				,
				"Help - The Fastest Mouse Clicker for Windows Classic", MB_OK | MB_ICONINFORMATION | MB_TOPMOST);
			break;
		case FOLDER_BTN:
			{
