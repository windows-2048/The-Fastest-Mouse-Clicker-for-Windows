/**************************************************************************
* The Fastest Mouse Clicker for Windows Classic version 2.1.6.0
...
LRESULT CALLBACK winCallBack(HWND hWin, UINT msg, WPARAM wp, LPARAM lp) 
{
	...
	case WM_COMMAND:
		...
		case RESET_BTN:
			...
			break;
		case HELP_BTN:
			MessageBox(hWnd, "The Fastest Mouse Clicker for Windows Classic x64 2.1.6.0 (Independent Keys For Toggle Clicking; Window Always Top; Random Clicking)."
