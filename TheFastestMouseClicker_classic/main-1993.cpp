/**************************************************************************
* The Fastest Mouse Clicker for Windows Classic version 2.1.7.0
* Copyright (c) 2016-2026 by Open Source Developer Masha Novedad
...
int WINAPI WinMain(HINSTANCE instanceH, HINSTANCE prevInstanceH, LPSTR command_line, int show)
{
	...
	windClass.lpszClassName	= "The Fastest Mouse Clicker for Windows Classic x64";

	//Registering the window class
	RegisterClass(&windClass);

	hWnd=CreateWindow("The Fastest Mouse Clicker for Windows Classic x64","The Fastest Mouse Clicker for Windows Classic x64", WS_OVERLAPPEDWINDOW, Sc(100), Sc(100),Sc(438),Sc(480), NULL, NULL, instanceH, NULL);

// SET THE ICON RIGHT AFTER CREATING WINDOW
if (hWnd)
{
    HICON hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_ICON1)); // Try 1, 101, or your icon ID
    if (hIcon)
    {
	...
	if (!statusText) {
		...
		fprintf(stderr, "Failed to create status text. Error: %lu", err);
	}
	...
	triggerKey = CreateWindow("Static","begin/end trigger keys",WS_VISIBLE|WS_CHILD,Sc(5),Sc(80),Sc(410),Sc(20),hWnd,0,0,0);
	...
	stopButton =		CreateWindow("Button","STOP!",WS_VISIBLE | WS_CHILD,Sc(5),Sc(125),Sc(410),Sc(50),hWnd,(HMENU)STOP_BTN,0,0);
...
LRESULT CALLBACK winCallBack(HWND hWin, UINT msg, WPARAM wp, LPARAM lp) 
{
	...
	case WM_COMMAND:
		...
		case RESET_BTN:
			...
			break;
		case HELP_BTN:
			MessageBox(hWnd, "The Fastest Mouse Clicker for Windows Classic x64 2.1.7.0 (Independent Keys For Toggle Clicking; Window Always Top; Random Clicking)."
				...
				,
				"Help - The Fastest Mouse Clicker for Windows Classic x64", MB_OK | MB_ICONINFORMATION | MB_TOPMOST);
			break;
		case FOLDER_BTN:
			{
	...
	case WM_CREATE:
		{			
			...
			logFontBold.lfHeight = Sc(-nFontSize);
